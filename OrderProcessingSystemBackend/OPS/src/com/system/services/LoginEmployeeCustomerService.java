...
public interface LoginEmployeeCustomerService {
	boolean loginCustomer(int id, String password) throws SQLException, NoSuchCustomerFoundException;
	boolean loginEmployee(int id, String password) throws SQLException, NoSuchEmployeeFoundException;
